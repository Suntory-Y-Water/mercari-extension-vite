...
export class Constants {
  ...
  public static readonly SELECTOR = {
    ...
    LISTINGS: {
      ...
      /** 出品日時 */
      TIME: 'div.content__884ec505 > a > div > div > div.content__97a42da1 > div.metaContainer__97a42da1 > span:nth-child(4) > span',
      /**
       * @description フリマアシストのボタン要素の前部分
       */
      FLEA_ASSIST_BUTTON_PREVIOUS: '#currentListing > div.merList.border__17a1e07b.separator__17a1e07b',
      /**
